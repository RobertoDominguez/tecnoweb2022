                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Inicio de Seccion</h1>
                                    </div>
                                    @if ($errors->any())
                                    ...
                                    @endif
                                    <hr>
                                    <form class="user" ction="{{ route('usuario.ingresar') }}" method="POST">
                                        {{ csrf_field() }}
                                        ...
                                        <input type="submit" class="btn btn-primary btn-user btn-block" value="Iniciar Seccion">
                                        <hr>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="{{ route('index') }}">Volver a la inicio</a>
                                    </div>
                                    
                                    <div class="text-center">
                                        Contador de pagina: {{$contador->count}}.
                                    </div>
