    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ $usuario->u_nom }}</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ $usuario->acceso->a_tipo }}</div>
                                </div>
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                ...
                                <form method="POST" action="{{ route('usuario.editar.guardar', $usuario->u_id) }}">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-md-4 col-lg-3 col-form-label">Modificar Tipo de
                                            Usuario</label>
                                        <div class="col-sm-9">
                            ...
                            <div class="tab-pane fade pt-3" id="profile-change-password">
                                ...
                                <form method="POST"
                                    action="{{ route('acceso.editar.guardar', $usuario->acceso->a_id) }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row mb-3">
                                        <label for="currentPassword" class="col-md-4 col-lg-3 col-form-label">Antigua
                                            contraseña</label>
                                        <div class="col-md-8 col-lg-9">
                                    ...
                                    <div class="row mb-3">
                                        <label for="renewpassword" class="col-md-4 col-lg-3 col-form-label">Vuelve a
                                            escribir la nueva contraseña</label>
                                        <div class="col-md-8 col-lg-9">
